...
function printAllAnswers(questions) {
    ...
    for (let i = 0; i < questions.length; i++) {
        ...
        arrAnswers.push(questions[i])
        arrLabels[arrLabels.length] = printLabel(questions[i]);
        arrInputs[arrInputs.length] = printInput(questions[i]);
